...
public class PersistentLoginService extends TokenBasedRememberMeServices
{
     ...
     *            
     *            
     * @author yardmap-cm325 for cas without single sign out, we need to be able to set up cascading signout from apps
     *						    but in some cases, its possible that they might not yet even be signed into es, so include
     *								a pass through for when users arent logged in 						
     */
